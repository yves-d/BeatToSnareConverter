...
{
    public class ConvertBeatToSnaresTests
    {
        ...
        {
            // arrange
            var expectedSnares = "sn4 sn4 sn4 sn4";
            List<int> inputBeats = new List<int>(){ 1,1,1,1 };

            // act
            IBeatConverter converter = new BeatConverter();
            var result = converter.ConvertBeatsToSnares(inputBeats);

            // assert
            result.Should().Be(expectedSnares);
        }
        ...
        {
            // arrange
            var expectedSnares = "sn2 sn4 sn4";
        ...
        {
            // arrange
            var expectedSnares = "sn2 sn2";
            List<int> inputBeats = new List<int>() { 1, 0, 0, 0, 1, 0, 0, 0 };
        ...
        {
            // arrange
            var expectedSnares = "sn2 sn8 sn8 sn8 sn8";
